...
--
-- Name: apply_inventory_movement(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
declare
  v_staff_id text;
begin
  v_staff_id := nullif(current_setting('app.staff_id', true), '');
  begin
    return v_staff_id::uuid;
  exception when others then
    return null; -- jika format salah, tolak akses secara aman
  end;
end;
$$;


ALTER FUNCTION public.get_current_staff_id() OWNER TO postgres;
...
--
-- Name: is_staff_of_store(uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.is_staff_of_store(p_store_id uuid) RETURNS boolean
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO 'public', 'pg_temp'
    AS $$
  select exists (
...
CREATE TABLE public.tax_categories (
    ...
    active boolean DEFAULT true NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT chk_exempt_rate CHECK ((((tax_type)::text <> 'exempt'::text) OR (rate = (0)::numeric))),
    CONSTRAINT chk_tax_rate_range CHECK (((rate >= (0)::numeric) AND (rate <= (100)::numeric))),
    CONSTRAINT tax_categories_tax_type_check CHECK (((tax_type)::text = ANY ((ARRAY['ppn'::character varying, 'ppn_mewah'::character varying, 'pbjt'::character varying, 'exempt'::character varying])::text[])))
);
...
--
-- Name: inventory_stock inventory_stock_variant_id_store_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: sales sales_store_id_sale_number_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: staff_stores staff_stores_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.staff_stores
    ADD CONSTRAINT staff_stores_pkey PRIMARY KEY (staff_id, store_id);
...
--
-- Name: idx_expenses_staff_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_expenses_staff_id ON public.expenses USING btree (staff_id);


--
-- Name: idx_expenses_store_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_movements_variant_store; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_movements_variant_store ON public.inventory_movements USING btree (variant_id, store_id);
...
--
-- Name: idx_po_items_po; Type: INDEX; Schema: public; Owner: postgres
--
...
CREATE INDEX idx_products_active ON public.products USING btree (id) WHERE ((deleted_at IS NULL) AND active);
...
--
-- Name: idx_products_tax_category_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_products_tax_category_id ON public.products USING btree (tax_category_id);


--
-- Name: idx_purchase_orders_staff_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_purchase_orders_staff_id ON public.purchase_orders USING btree (staff_id);
...
--
-- Name: idx_sale_items_variant_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_sale_return_items_sale_item_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_sale_return_items_sale_item_id ON public.sale_return_items USING btree (sale_item_id);


--
-- Name: idx_sale_return_items_sale_return_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_sale_return_items_sale_return_id ON public.sale_return_items USING btree (sale_return_id);


--
-- Name: idx_sale_returns_sale_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_sale_returns_sale_id ON public.sale_returns USING btree (sale_id);
...
--
-- Name: idx_sales_register_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_sales_register_id ON public.sales USING btree (register_id);


--
-- Name: idx_sales_staff_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_shifts_register_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_shifts_register_id ON public.shifts USING btree (register_id);


--
-- Name: idx_shifts_staff_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_staff_stores_store_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_staff_stores_store_id ON public.staff_stores USING btree (store_id);


--
-- Name: idx_stock_store; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_stock_store ON public.inventory_stock USING btree (store_id);
...
CREATE INDEX idx_variants_active ON public.product_variants USING btree (product_id) WHERE ((deleted_at IS NULL) AND active);
...
--
-- Name: uq_one_open_shift_per_register; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX uq_one_open_shift_per_register ON public.shifts USING btree (register_id) WHERE (closed_at IS NULL);
...
--
-- Name: sale_items trg_check_tax_category_sale_items; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: sales trg_sales_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: stores trg_stores_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: inventory_movements inventory_movements_staff_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
ALTER TABLE ONLY public.inventory_movements
    ADD CONSTRAINT inventory_movements_store_id_fkey FOREIGN KEY (store_id) REFERENCES public.stores(id);
...
--
-- Name: inventory_stock inventory_stock_store_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.inventory_stock
    ADD CONSTRAINT inventory_stock_store_id_fkey FOREIGN KEY (store_id) REFERENCES public.stores(id) ON DELETE CASCADE;


--
-- Name: inventory_stock inventory_stock_variant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: purchase_order_items purchase_order_items_variant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: purchase_orders purchase_orders_staff_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.purchase_orders
    ADD CONSTRAINT purchase_orders_staff_id_fkey FOREIGN KEY (staff_id) REFERENCES public.staff(id);
...
--
-- Name: registers registers_store_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.registers
    ADD CONSTRAINT registers_store_id_fkey FOREIGN KEY (store_id) REFERENCES public.stores(id);
...
--
-- Name: sale_items sale_items_tax_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sale_items
    ADD CONSTRAINT sale_items_tax_category_id_fkey FOREIGN KEY (tax_category_id) REFERENCES public.tax_categories(id);
...
--
-- Name: sale_return_items sale_return_items_sale_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sale_return_items
    ADD CONSTRAINT sale_return_items_sale_item_id_fkey FOREIGN KEY (sale_item_id) REFERENCES public.sale_items(id);


--
-- Name: sale_return_items sale_return_items_sale_return_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: sale_returns sale_returns_staff_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sale_returns
    ADD CONSTRAINT sale_returns_staff_id_fkey FOREIGN KEY (staff_id) REFERENCES public.staff(id);
...
--
-- Name: sales sales_register_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sales
    ADD CONSTRAINT sales_register_id_fkey FOREIGN KEY (register_id) REFERENCES public.registers(id);
...
--
-- Name: sales sales_staff_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: shifts shifts_register_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.shifts
    ADD CONSTRAINT shifts_register_id_fkey FOREIGN KEY (register_id) REFERENCES public.registers(id);
...
ALTER TABLE ONLY public.shifts
    ADD CONSTRAINT shifts_staff_id_fkey FOREIGN KEY (staff_id) REFERENCES public.staff(id);
...
--
-- Name: staff_stores staff_stores_staff_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.staff_stores
    ADD CONSTRAINT staff_stores_staff_id_fkey FOREIGN KEY (staff_id) REFERENCES public.staff(id) ON DELETE CASCADE;


--
-- Name: staff_stores staff_stores_store_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.staff_stores
    ADD CONSTRAINT staff_stores_store_id_fkey FOREIGN KEY (store_id) REFERENCES public.stores(id) ON DELETE CASCADE;


--
-- Name: stores stores_default_tax_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.stores
    ADD CONSTRAINT stores_default_tax_category_id_fkey FOREIGN KEY (default_tax_category_id) REFERENCES public.tax_categories(id);
...
CREATE POLICY catalog_read ON public.products FOR SELECT USING ((public.get_current_staff_id() IS NOT NULL));


--
-- Name: products catalog_write; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY catalog_write ON public.products USING (public.is_admin()) WITH CHECK (public.is_admin());
...
--
-- Name: categories categories_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY categories_read ON public.categories FOR SELECT USING ((public.get_current_staff_id() IS NOT NULL));


--
-- Name: categories categories_write; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY categories_write ON public.categories USING (public.is_admin()) WITH CHECK (public.is_admin());
...
--
-- Name: customers customers_delete; Type: POLICY; Schema: public; Owner: postgres
--
...
CREATE POLICY customers_insert ON public.customers FOR INSERT WITH CHECK ((public.get_current_staff_id() IS NOT NULL));
...
CREATE POLICY customers_select ON public.customers FOR SELECT USING ((public.get_current_staff_id() IS NOT NULL));
...
CREATE POLICY customers_update ON public.customers FOR UPDATE USING ((public.get_current_staff_id() IS NOT NULL)) WITH CHECK ((public.get_current_staff_id() IS NOT NULL));
...
--
-- Name: discounts discounts_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY discounts_read ON public.discounts FOR SELECT USING ((public.is_admin() OR (store_id IS NULL) OR public.is_staff_of_store(store_id)));


--
-- Name: discounts discounts_write; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY discounts_write ON public.discounts USING (public.is_admin()) WITH CHECK (public.is_admin());
...
--
-- Name: expenses expenses_scoped; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY expenses_scoped ON public.expenses USING (public.is_staff_of_store(store_id)) WITH CHECK (public.is_staff_of_store(store_id));
...
--
-- Name: inventory_movements inventory_movements_insert; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY inventory_movements_insert ON public.inventory_movements FOR INSERT WITH CHECK ((public.is_staff_of_store(store_id) AND (staff_id = public.get_current_staff_id())));


--
-- Name: inventory_movements inventory_movements_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY inventory_movements_read ON public.inventory_movements FOR SELECT USING (public.is_staff_of_store(store_id));
...
--
-- Name: payments payments_scoped; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY payments_scoped ON public.payments USING ((EXISTS ( SELECT 1
   FROM public.sales
  WHERE ((sales.id = payments.sale_id) AND public.is_staff_of_store(sales.store_id))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM public.sales
  WHERE ((sales.id = payments.sale_id) AND public.is_staff_of_store(sales.store_id)))));
...
--
-- Name: purchase_order_items purchase_order_items_scoped; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY purchase_order_items_scoped ON public.purchase_order_items USING ((EXISTS ( SELECT 1
   FROM public.purchase_orders po
  WHERE ((po.id = purchase_order_items.purchase_order_id) AND public.is_staff_of_store(po.store_id))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM public.purchase_orders po
  WHERE ((po.id = purchase_order_items.purchase_order_id) AND public.is_staff_of_store(po.store_id)))));
...
--
-- Name: purchase_orders purchase_orders_scoped; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY purchase_orders_scoped ON public.purchase_orders USING (public.is_staff_of_store(store_id)) WITH CHECK (public.is_staff_of_store(store_id));
...
--
-- Name: registers registers_scoped; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY registers_scoped ON public.registers USING (public.is_staff_of_store(store_id)) WITH CHECK (public.is_staff_of_store(store_id));
...
CREATE POLICY roles_read ON public.roles FOR SELECT USING ((public.get_current_staff_id() IS NOT NULL));
...
CREATE POLICY roles_write ON public.roles USING (public.is_admin()) WITH CHECK (public.is_admin());
...
--
-- Name: sale_items sale_items_scoped; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY sale_items_scoped ON public.sale_items USING ((EXISTS ( SELECT 1
   FROM public.sales
  WHERE ((sales.id = sale_items.sale_id) AND public.is_staff_of_store(sales.store_id))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM public.sales
  WHERE ((sales.id = sale_items.sale_id) AND public.is_staff_of_store(sales.store_id)))));


--
-- Name: sale_return_items; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.sale_return_items ENABLE ROW LEVEL SECURITY;

--
-- Name: sale_return_items sale_return_items_scoped; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY sale_return_items_scoped ON public.sale_return_items USING ((EXISTS ( SELECT 1
   FROM (public.sale_returns sr
     JOIN public.sales s ON ((s.id = sr.sale_id)))
  WHERE ((sr.id = sale_return_items.sale_return_id) AND public.is_staff_of_store(s.store_id))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM (public.sale_returns sr
     JOIN public.sales s ON ((s.id = sr.sale_id)))
  WHERE ((sr.id = sale_return_items.sale_return_id) AND public.is_staff_of_store(s.store_id)))));
...
--
-- Name: sale_returns sale_returns_scoped; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY sale_returns_scoped ON public.sale_returns USING ((EXISTS ( SELECT 1
   FROM public.sales
  WHERE ((sales.id = sale_returns.sale_id) AND public.is_staff_of_store(sales.store_id))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM public.sales
  WHERE ((sales.id = sale_returns.sale_id) AND public.is_staff_of_store(sales.store_id)))));
...
--
-- Name: sales sales_scoped; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY sales_scoped ON public.sales USING (public.is_staff_of_store(store_id)) WITH CHECK (public.is_staff_of_store(store_id));
...
--
-- Name: shifts shifts_scoped; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY shifts_scoped ON public.shifts USING ((EXISTS ( SELECT 1
   FROM public.registers r
  WHERE ((r.id = shifts.register_id) AND public.is_staff_of_store(r.store_id))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM public.registers r
  WHERE ((r.id = shifts.register_id) AND public.is_staff_of_store(r.store_id)))));
...
--
-- Name: staff staff_admin_write; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY staff_admin_write ON public.staff USING (public.is_admin()) WITH CHECK (public.is_admin());


--
-- Name: staff staff_self_or_admin; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY staff_self_or_admin ON public.staff FOR SELECT USING (((id = public.get_current_staff_id()) OR public.is_admin()));


--
-- Name: staff_stores; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.staff_stores ENABLE ROW LEVEL SECURITY;

--
-- Name: staff_stores staff_stores_admin_write; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY staff_stores_admin_write ON public.staff_stores USING (public.is_admin()) WITH CHECK (public.is_admin());


--
-- Name: staff_stores staff_stores_visible; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY staff_stores_visible ON public.staff_stores FOR SELECT USING (((staff_id = public.get_current_staff_id()) OR public.is_admin()));
...
--
-- Name: stores stores_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY stores_read ON public.stores FOR SELECT USING (public.is_staff_of_store(id));


--
-- Name: stores stores_write; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY stores_write ON public.stores USING (public.is_admin()) WITH CHECK (public.is_admin());
...
--
-- Name: suppliers suppliers_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY suppliers_read ON public.suppliers FOR SELECT USING ((public.get_current_staff_id() IS NOT NULL));
...
CREATE POLICY suppliers_write ON public.suppliers USING (public.is_admin()) WITH CHECK (public.is_admin());
...
--
-- Name: tax_categories tax_categories_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY tax_categories_read ON public.tax_categories FOR SELECT USING ((public.get_current_staff_id() IS NOT NULL));
...
CREATE POLICY tax_categories_write ON public.tax_categories USING (public.is_admin()) WITH CHECK (public.is_admin());


--
-- Name: product_variants variants_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY variants_read ON public.product_variants FOR SELECT USING ((public.get_current_staff_id() IS NOT NULL));


--
-- Name: product_variants variants_write; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY variants_write ON public.product_variants USING (public.is_admin()) WITH CHECK (public.is_admin());
